            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 mb-6">
              ...
              <div>
                ...
                <ul className="space-y-1 sm:space-y-2">
                  <li>
                    <Link to="/" className="text-base text-gray-600 hover:text-primary-600 flex items-center">
                  ...
                  <li>
                    <Link to="/columns" className="text-base text-gray-600 hover:text-primary-600 flex items-center">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li>
                    <Link to="/news" className="text-base text-gray-600 hover:text-primary-600 flex items-center">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <ul className="space-y-1 sm:space-y-2">
                  ...
                  <li>
                    <Link to="/privacy" className="text-base text-gray-600 hover:text-primary-600 flex items-center">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="col-span-2 md:col-span-1 mt-4 md:mt-0">
                <h3 className="text-base font-semibold text-gray-700 mb-2 sm:mb-4">お問い合わせ・SNS</h3>
                <ul className="space-y-1 sm:space-y-2">
                  <li>
                    <a
